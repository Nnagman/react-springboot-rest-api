...
public class OrderJdbcRepository implements OrderRepository {
    ...
    public Order insert(Order order) {
        ...
        order.getOrderItems().forEach(item ->
                jdbcTemplate.update("INSERT INTO orders_items(order_id, product_id, category, price, quantity, created_at, updated_at) " +
    ...
    private Map<String, Object> toOrderItemParamMap(UUID orderId,
